    ...
    _buildFrame() {
        ...
        while(gameObjectQueue.length) {
            ...
            children.forEach((child) => {
               child.globalPosition = this._calculateGameObjectGlobalPosition(currentGameObject.globalPosition, child);

               const screenPos = this._calculateGameObjectCameraPosition(this._cameraPosition, this._cameraSize, child.globalPosition, child.size);
