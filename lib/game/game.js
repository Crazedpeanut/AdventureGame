...
export default class Game {
    constructor(input, graphics, assetLoader, gameWidth, gameHeight) {
        ...
        this.gameStartMilliseconds = Date.now();
        this.currentFrameStartTime = this.gameStartMilliseconds;
        this.lastFrameEndTime = this.currentFrameStartTime;
    }

    getMillisecondsSinceGameStart() {
        return Date.now() - this.gameStartMilliseconds;
    }

    getElapsedMillisSinceCurrentFrame() {
        return Date.now() - this.currentFrameStartTime;
    }

    getElapsedMillisSinceLastFrame() {
        return Date.now() - this.lastFrameEndTime;
    }
    ...
    _blitScene(drawables) {
        const newCanvas = this._graphics._createCanvas();
